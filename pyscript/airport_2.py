...
state.persist("pyscript.airport_2_playing")

@time_trigger("period(2020/01/01, 5sec)")
async def get_giga_state():
    async with aiohttp.ClientSession() as session:
        try:
            async with session.get("http://192.168.1.44:7000/info") as res:
                ...
                pyscript.airport_2_playing = playing

        except Exception as e:
            pyscript.airport_2_playing = "Error: " + repr(e)